...
public class VodRectHolder extends BaseVodHolder {
    ...
    public void initView(Vod item) {
        ...
        // Binding can outrun the focus listener when the grid restores focus
        // while the new holder is still being measured; mirror the History
        // presenter pattern and publish a synchronous focus event.
